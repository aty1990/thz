			...
			<mt-tab-container class="page-tabbar-container" v-model="selected">
				<mt-tab-container-item id="首页">
					<div class="flex pd-all-6 search-wrap">
						<input type="text" class="grow font-size-12" placeholder="搜宝贝">
					...
					<div class="mgt-10 mgb-10">
						...
						<div>
						<!-- 	<p class="flex goods-title mgt-10"><span class="mgr-6">支付优选</span><img src="/thz/static/home-more.png" height="14"></p> -->
							...
							<!-- <div class="tab" ref="tab">
						            <div class="tab_content" ref="tabcontent">
						                <div class="tab_item" v-for="goods in nloanGoods">
						...
						<div class="mgt-10">
							<p class="flex goods-title" @click="jpfq"><span class="mgr-6">猜你喜欢</span></p>
							<div class="home-component flex">
								<div class="goods-item" v-for="goods in likeGoods" @click.stop="toGoodDetail(goods)">
									<div class="pdt-20 pdb-10 min-he-100">
										<img v-lazy="goods.goodsPicurl" width="90%" style="margin-left: 5%;">
									</div>
									<div class="text-deal1">{{goods.goodsName}}</div>
				...
				<mt-tab-container-item id="换钱">
					...
					<div class="pawn-component">
						...
						<div v-if="pawnList.length==0" class="no-pawn-order flex vertical">
			...
			initData(){
	        	...
	        	api.indexPage({}).then(res=>{
					if(res.code=="200"){
						...
						// 猜你喜欢
						_self.likeGoods = res.body.loan_goods;
