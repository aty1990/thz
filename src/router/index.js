...
const Bankcard = r => require.ensure([], () => r(require('@/page/mine/bankcard')), 'bankcard');
...
const Receipt = r => require.ensure([], () => r(require('@/page/order/receipt')), 'receipt');
...
const PawnOrderDetail = r => require.ensure([], () => r(require('@/page/order/pawn-order-detail')), 'pawnOrderDetail');
...
const GenerateOrder = r => require.ensure([], () => r(require('@/page/order/generate-order')), 'generateOrder');
...
export default new Router({
    ...
    }, 
    {
        ...
        component: Home,
        children: [
            { path: '/home/sale', name: 'sale', meta: { title: "淘花宅" }, component: Sale},
            { path: '/home/sale/complete', name: 'complete', meta: { title: "淘花宅" }, component: Complete },
            { path: '/home/kefu', name: 'kefu', meta: { title: "联系客服" }, component: Kefu},
            { path: '/home/shouhou', name: 'shouhou', meta: { title: "售后客服" }, component: Shouhou},
            { path: '/home/help', name: 'help', meta: { title: "常见问题" }, component: Help},
            { path: '/home/progress', name: 'progress', meta: { title: "进度详情" }, component: Progress},
                ...
                children : [
                    {
                        ...
                        component: Repayment,
                        children:[
                            { path: '/bankcard', name: 'bankcard', meta: { title: "还款" }, component: Bankcard,
                                children : [
                                    { path: '/addBankCard', name: 'addBankCard', meta: { title: "银行卡" }, component:Mbankcard }
                                ]
                            }
                        ]
                    },
                    {
                        ...
                        children:[
                            { path: '/early-repay/bankcard', name: 'ebankcard', meta: { title: "提前还款" }, component: Bankcard,
                                children : [
                                    { path: '/eaddBankCard', name: 'eaddBankCard', meta: { title: "银行卡" }, component:Mbankcard }
                                ]
                            }
                        ]
                    }
            ...
            { path: '/home/shipping-address', name: 'shippingAddress', meta: { title: "我的收货地址" }, component: ShippingAddress,
                children : [
            ...
            { path: '/home/receipt', name: 'receipt', meta: { title: "交易成功" }, component: Receipt },
            ...
            { path: '/home/pawn', name: 'pawn', meta: { title: "转卖订单" }, component: PawnOrder,
                children : [
                    { path: '/pawn-order-detail', name: 'pawnOrderDetail', meta: { title: "转卖详情" }, component: PawnOrderDetail,
                        children : [
                            { path: '/pawn-order-detail/kefu', name: 'pawnkefu', meta: { title: "联系客服" }, component: Kefu }
                        ]
                    }
                ]
            },
            { path: '/home/order', name: 'order', meta: { title: "购买订单列表" }, component: Order,
                children : [
                    ...
                    { path: '/home/order/saleOrder', name: 'saleOrder', meta: { title: "换了卖钱" }, component: PawnOrderDetail }
                ]
            },
            ...
            { path: '/home/goods-detail', name: 'goods-detail', meta: { title: "商品详情" }, component: GoodsDetail,
                children :[
                    { path: '/generate', name: 'generate', meta: { title: "提交订单" }, component: GenerateOrder,
                        children:[
                            { path: '/order/shipping-address', name: 'orderAddress', meta: { title: "我的收货地址" }, component: ShippingAddress}
                        ]
                    }
                ]
            },
    ...
    {path: '/channel', name: 'mbankcard', meta: { title: "淘花宅" }, component: Channel,
        children : [
